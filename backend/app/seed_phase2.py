...
AI_PROMPTS_SEED = [
    {
        "slug": AssistantSlug.seo_architect,
        "name": "Arquitecto SEO",
    ...
    {
        "slug": AssistantSlug.keyword_classifier,
    ...
    {
        "slug": AssistantSlug.content_generator,
    ...
    {
        "slug": AssistantSlug.competitor_analyst,
    ...
    {
        "slug": AssistantSlug.continuous_optimizer,
